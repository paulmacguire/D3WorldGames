      ...
      var arcs = arc.append("g")
        ...
        arcs.append("path")
          ...
          .on("mouseover", function() {
            var currentColor = d3.color(d3.select(this).attr("fill"));
            var brighterColor = currentColor.brighter(0.2); // Increase brightness by 20%
            ...
            arcs.selectAll("path")
              ...
              .attr("fill", function() {
                ...
                return color.darker(0.2); // Darken the color by 20%
              });

            // Set hovered element to brighter color
            d3.select(this)
