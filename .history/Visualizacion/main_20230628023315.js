  ...
  function ready(error, worldData) {
    ...
    function createPieChart(genres, region) {
      ...
      var ordScale = d3
        ...
        .range(function(region) {
          if (region === "NA_Sales") {
            return ['#8E9B90', '#93C0A4', '#B6C4A2', '#D4CDAB', '#DCE2BD', '#BFC1B8', '#99A172', '#808E3B'];
          } else if (region === "EU_Sales") {
            return ['#123456', '#789ABC', '#DEF123', '#456DEF', '#ABC456', '#789DEF', '#DEF789', '#ABC123'];
          } else if (region === "JP_Sales") {
            return ['#ABC123', '#DEF456', '#456ABC', '#789DEF', '#DEFABC', '#123456', '#789ABC', '#ABCDEF'];
          } else if (region === "Other_Sales") {
            return ['#987654', '#321098', '#654321', '#987123', '#123789', '#654987', '#321456', '#987321'];
          }
        });
