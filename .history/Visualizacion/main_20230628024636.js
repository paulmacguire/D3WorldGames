...
const colorPalettes = [{ name: "NA_Sales", colors: ['#8E9B90', '#93C0A4', '#B6C4A2', '#D4CDAB', '#DCE2BD', '#BFC1B8', '#99A172', '#808E3B'] },
                       { name: "EU_Sales", colors: ['#8E9B90', '#93C0A4', '#B6C4A2', '#D4CDAB', '#DCE2BD', '#BFC1B8', '#99A172', '#808E3B'] },
                       { name: "JP_Sales", colors: ['#8E9B90', '#93C0A4', '#B6C4A2', '#D4CDAB', '#DCE2BD', '#BFC1B8', '#99A172', '#808E3B'] },
                       { name: "Other_Sales", colors: ['#8E9B90', '#93C0A4', '#B6C4A2', '#D4CDAB', '#DCE2BD', '#BFC1B8', '#99A172', '#808E3B'] } ]
