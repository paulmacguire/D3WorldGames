...
function createVGMap() {
  ...
  function ready(error, worldData) {
    ...
    function createPieChart(genres) {
      ...
      const data = Object.entries(genres).map(([genre, sales]) => ({ genre, value: sales }));
    ...
    contenedorPrimeraVisualizacion
      ...
      .on("click", (event, d) => {
        ...
        d3.select("#gameList")
          ...
          .append("li")
          .html((d) => {
            return `<strong>${d.Name}</strong> (${d.Platform}) - Ventas: ${d[region]} millones`;
          });
      });
    ...
    var legendItems = legend
      .selectAll("g")
      .data(["Ventas globales", "Ventas en Norteamérica", "Ventas en Europa", "Ventas en Japón"])
      .enter()
      .append("g")
      .attr("class", "legend-item")
      .attr("transform", function (d, i) {
        var height = legendRectSize + legendSpacing;
        var offset = (height * 4 - legendSpacing) / 2;
        var horz = WIDTH_1 - 350;
