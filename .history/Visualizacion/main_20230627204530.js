    ...
    contenedorPrimeraVisualizacion
      ...
      .on("click", (event, d) => {
        ...
        contenedorPrimeraVisualizacion
          .selectAll(".country")
          .filter((d) => {
            regionCountryName = d.properties.name;
            if (region === "NA_Sales") {
        ...
        d3.select("#gameList")
        .append("h2")
        .text("Top 30 juegos más vendidos en " + regionCountryName + " (millones de copias)");
