...
SVG2.attr("width", WIDTH_2 + 400).attr("height", HEIGHT_2);
...
function createPieChart(genres, region) {
  ...
  if (!pieChartSVG) {
    ...
    pieChartSVG = SVG2.append("g")
      .attr("transform", `translate(${WIDTH_2 / 2 + 300 }, ${HEIGHT_2 / 2 - 40})`);
  } else {
  ...
  switch (region) {
    ...
    case "JP_Sales":
      ...
      break;
    case "Other_Sales":
      regionName = "in <br><\br>other countries";
      break;
    case "Global_Sales":
  ...
  pieChartSVG.append("text")
    ...
    .text(`Top selled genres ${regionName}`)
